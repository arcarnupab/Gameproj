...
public class Bomb
{
    ...
    public Bomb(final int rowIndex, final int colIndex, int explosionRadius) {
        this.rowIndex = rowIndex;//แถวที่วาดระเบิด
        this.colIndex = colIndex;//คอลลัมที่วาดระเบิด
        this.explosionRadius = explosionRadius; //รัศมีระเบิด
        playerLeft = false; //เช็ค player หาย
    }

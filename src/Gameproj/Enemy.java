...
public class Enemy extends AbstractCharacter
{
    ...
    public Enemy(int x, int y, boolean vertical) {
        super(x, y, 1);//เซ็ท position แต่ละ enemy
        currentDirection = randomDirection(vertical); ///pass vertical to randomDirection
    }
    ...
    private Move randomDirection(boolean vertical) { ///random direction enemy walk

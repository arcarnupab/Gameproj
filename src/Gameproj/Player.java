...
public class Player extends AbstractCharacter
{
    ...
    public int getBombCount() {  ///เรียก bombCount
	return bombCount;
    }

    public void setBombCount(int bombCount) {  ///เซํต bombCount
	this.bombCount = bombCount;
    }

    public int getExplosionRadius() {  ///เรียก Radius of Explosion
	return explosionRadius;
    }

    public void setExplosionRadius(int explosionRadius) {  /// เซ็ต Radius of Explosion 
